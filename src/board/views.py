...
def new_topic(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            Which means if we save the form without providing a "board" and "starter" value, it will throw an exception.
...
# This class base function is used to create a post. Login is required before posting any post.
...
class PostUpdateView(UpdateView):
    ...
    """
    To rename it to post instead. Navigating through the post object: "post.topic.board.pk".
